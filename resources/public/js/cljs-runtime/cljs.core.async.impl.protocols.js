...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28250 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28250(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28255 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28255(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28270 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28270(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28275 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28275(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28276 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28276(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28279 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28279(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28284 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28284(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28289 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28289(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28294 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28294(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28295 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28295(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28296 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28296(b);
}
});
