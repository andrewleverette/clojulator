...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"calculate","calculate",-1224644403),(function (db,p__29003){
var vec__29004 = p__29003;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29004,(0),null);
var expression = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29004,(1),null);
var vec__29007 = clojulator.calculator.core.calculate(expression,new cljs.core.Keyword(null,"history","history",-247395220).cljs$core$IFn$_invoke$arity$1(db));
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29007,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29007,(1),null);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mb-3"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"for","for",-1323786319),"expressionInput",new cljs.core.Keyword(null,"class","class",-2030961996),"form-label"], null),"Expression"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"class","class",-2030961996),"form-control",new cljs.core.Keyword(null,"id","id",-1388402092),"expressionInput",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(value),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__29010_SHARP_){
return cljs.core.reset_BANG_(value,p1__29010_SHARP_.target.value);
})], null)], null)], null);
});
