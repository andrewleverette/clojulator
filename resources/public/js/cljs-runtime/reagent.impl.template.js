...
var G__38542 = o;
reagent.impl.template.goog$module$goog$object.set(G__38542,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__38566__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38566 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38567__i = 0, G__38567__a = new Array(arguments.length -  0);
while (G__38567__i < G__38567__a.length) {G__38567__a[G__38567__i] = arguments[G__38567__i + 0]; ++G__38567__i;}
  args = new cljs.core.IndexedSeq(G__38567__a,0,null);
} 
return G__38566__delegate.call(this,args);};
G__38566.cljs$lang$maxFixedArity = 0;
G__38566.cljs$lang$applyTo = (function (arglist__38568){
var args = cljs.core.seq(arglist__38568);
return G__38566__delegate(args);
});
...
var G__38543 = o;
reagent.impl.template.goog$module$goog$object.set(G__38543,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38569__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38569 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38570__i = 0, G__38570__a = new Array(arguments.length -  0);
while (G__38570__i < G__38570__a.length) {G__38570__a[G__38570__i] = arguments[G__38570__i + 0]; ++G__38570__i;}
  args = new cljs.core.IndexedSeq(G__38570__a,0,null);
} 
return G__38569__delegate.call(this,args);};
G__38569.cljs$lang$maxFixedArity = 0;
G__38569.cljs$lang$applyTo = (function (arglist__38571){
var args = cljs.core.seq(arglist__38571);
return G__38569__delegate(args);
});
G__38569.cljs$core$IFn$_invoke$arity$variadic = G__38569__delegate;
return G__38569;
})()
;
} else {
...
var G__38544 = props;
var G__38544__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38544,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38544);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38544__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38545 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38545,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38545;
}
})(),id_class);
...
var G__38546 = (cljs.core.count(argv) - first_child);
switch (G__38546) {
case (0):
...
var vec__38547 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38547,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38547,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38547,(2),null);
...
var temp__5827__auto___38579 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___38579 == null)){
} else {
var key_38580 = temp__5827__auto___38579;
(jsprops.key = key_38580);
}
...
var temp__5827__auto___38582 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___38582 == null)){
} else {
var key_38583 = temp__5827__auto___38582;
(jsprops.key = key_38583);
}
...
var temp__5827__auto___38587 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___38587 == null)){
} else {
var key_38588 = temp__5827__auto___38587;
(jsprops.key = key_38588);
}
...
var temp__5827__auto___38589 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___38589 == null)){
} else {
var key_38590 = temp__5827__auto___38589;
(jsprops.key = key_38590);
}
...
var temp__5827__auto___38591 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___38591 == null)){
} else {
var key_38592 = temp__5827__auto___38591;
(jsprops.key = key_38592);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38550_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38550_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38551 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38551,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38551,(1),null);
...
break;
default:
var G__38594 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38595 = compiler;
v = G__38594;
compiler = G__38595;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template38557 = (function (opts,id,fn_to_element,parse_fn,meta38558){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38557.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38559,meta38558__$1){
var self__ = this;
var _38559__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38557(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38558__$1));
}));

(reagent.impl.template.t_reagent$impl$template38557.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38559){
var self__ = this;
var _38559__$1 = this;
return self__.meta38558;
}));

(reagent.impl.template.t_reagent$impl$template38557.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38557.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38557.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38557.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38557.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38557.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38558","meta38558",1875739940,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38557.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38557.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38557");

(reagent.impl.template.t_reagent$impl$template38557.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template38557");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38557.
 */
reagent.impl.template.__GT_t_reagent$impl$template38557 = (function reagent$impl$template$__GT_t_reagent$impl$template38557(opts,id,fn_to_element,parse_fn,meta38558){
return (new reagent.impl.template.t_reagent$impl$template38557(opts,id,fn_to_element,parse_fn,meta38558));
});
...
return (new reagent.impl.template.t_reagent$impl$template38557(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
