...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38424 = c;
var G__38424__$1 = (((G__38424 == null))?null:G__38424.prototype);
if((G__38424__$1 == null)){
return null;
} else {
return G__38424__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38427 = c;
var G__38427__$1 = (((G__38427 == null))?null:G__38427.prototype);
if((G__38427__$1 == null)){
return null;
} else {
return G__38427__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__38435 = c;
var G__38435__$1 = (((G__38435 == null))?null:G__38435.constructor);
if((G__38435__$1 == null)){
return null;
} else {
return G__38435__$1.displayName;
}
})();
...
var G__38436 = c;
var G__38436__$1 = (((G__38436 == null))?null:G__38436.constructor);
if((G__38436__$1 == null)){
return null;
} else {
return G__38436__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38438 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38439 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38439);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38438);
}});
...
var c = this;
var G__38500_38527 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__38500_38527 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38500_38527);
}
...
var renders_38528 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38529 = cljs.core.first(cljs.core.vals(renders_38528));
...
if((cljs.core.count(renders_38528) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38528))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38529)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38529], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38512 = o;
reagent.impl.component.goog$module$goog$object.set(G__38512,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__38513 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38514 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38514);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38513);
}});
...
var vec__38515 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38515,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38515,(1),null);
...
var G__38518 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__38518 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38518);
}
});
}),[]);
