...
var i_31228 = (self__.level + (1));
while(true){
if((i_31228 <= (new_level + (1)))){
(update[i_31228] = self__.header);

var G__31231 = (i_31228 + (1));
i_31228 = G__31231;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31232 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31232[i]));
} else {
x__$2.forward.push((((i < links_31232.length))?(links_31232[i]):null));
}

if((i < links_31232.length)){
(links_31232[i] = x__$2);
} else {
links_31232.push(x__$2);
}
...
var i_31237 = (0);
while(true){
if((i_31237 <= self__.level)){
var links_31238 = (update[i_31237]).forward;
if((x__$1 === (((i_31237 < links_31238.length))?(links_31238[i_31237]):null))){
(links_31238[i_31237] = (x__$1.forward[i_31237]));

var G__31239 = (i_31237 + (1));
i_31237 = G__31239;
continue;
} else {
var G__31240 = (i_31237 + (1));
i_31237 = G__31240;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__31250 = nx;
var G__31251 = (level__$1 - (1));
x = G__31250;
level__$1 = G__31251;
continue;
} else {
var G__31253 = x;
var G__31254 = (level__$1 - (1));
x = G__31253;
level__$1 = G__31254;
continue;
}
